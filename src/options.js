...
const preferenceBindings = [{
    id: 'random-letters-search',
    elementKey: 'checked',
    preferenceKey: 'randomLettersSearch'
  },
  {
    id: 'custom-queries',
    elementKey: 'value',
    preferenceKey: 'customQueries'
  },
  {
    id: 'search-with-custom-queries',
    elementKey: 'checked',
    preferenceKey: 'searchWithCustomQueries'
  },
  {
    id: 'search-with-daily-trends',
    elementKey: 'checked',
    preferenceKey: 'searchWithDailyTrends'
  },
  {
    id: 'search-with-templates',
    elementKey: 'checked',
    preferenceKey: 'searchWithTemplates'
  },
  {
    id: 'schedule-daily-searches',
    elementKey: 'checked',
    preferenceKey: 'scheduleSearches'
  },
  {
    id: 'scheduled-time',
    elementKey: 'value',
    preferenceKey: 'scheduledTime'
  },
];
